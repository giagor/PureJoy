...
/**
 * edit by usagisang
 * @author Philip Dukhov
 * @param gradientEdgeColor 淡入淡出的颜色
 * @param animateDuration 动画持续的大致时间
 */
@Composable
fun MarqueeText(
    text: String,
...
fun MarqueeText(
    ...
    LaunchedEffect(textLayoutInfoState.value) {
        ...
        val duration = animateDuration * textLayoutInfo.textWidth / textLayoutInfo.containerWidth
        val delay = 1000L
